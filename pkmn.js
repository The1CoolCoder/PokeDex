...
var pokedex = {}; //{1: {name: "bulbasaur", "img" type: ["grass", "poison"], description}}
...
window.onload =  async function(){
   // getPokemon(1);
    ...
    document.getElementById("pokemon-description").innerHTML = pokedex[1]["desc"];
}
